      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100 dark:border-slate-700">
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            ...
            <button type="submit" className="w-full bg-indigo-600 border border-transparent text-white rounded-xl py-3 px-4 font-bold text-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/30-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-md">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700">
          ...
          <div className="flex space-x-3 mt-4 md:mt-0 items-center">
            ...
            <button 
              ...
              className={`px-4 py-2 rounded-lg font-bold text-sm transition-all flex items-center ${viewMode === 'detail' && !currentNoteId ? 'bg-indigo-600 text-white shadow-md' : 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30-100 dark:bg-indigo-900/50'}`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-bold text-sm transition-all flex items-center ${viewMode === 'profile' ? 'bg-blue-600 text-white shadow-md' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-blue-50 dark:bg-blue-900/20 hover:text-blue-600'}`}
            >
              主页
            </button>
            <ThemeToggle />
           ...
           <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-slate-700">
             ...
             <div className="flex flex-col md:flex-row gap-6">
                 ...
                 <div key={item.id} className="border border-gray-200 dark:border-slate-700 p-6 rounded-xl hover:shadow-xl hover:border-indigo-300 transition-all cursor-pointer bg-white dark:bg-slate-800 group hover:-translate-y-1" onClick={() => loadHistoryDetail(item)}>
                    <div className="flex justify-between items-start mb-3">
                          <p className="font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 truncate pr-3 flex-1" title={item.title || item.filename}>{item.title || item.filename}</p>
                            <div className="flex flex-col gap-1 items-end">
                                <span className="text-[10px] bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-400 px-2 py-0.5 rounded font-semibold whitespace-nowrap border border-indigo-100">{item.style}</span>
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300 line-clamp-3 leading-relaxed mb-4 font-normal bg-gray-50/50 p-3 rounded-lg border border-gray-100">{item.content.replace(/[#*]/g, '')}</div>
<div className="mt-4 text-sm text-indigo-600 dark:text-indigo-400 font-bold opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-between">
                          ...
                          <button 
                            ...
                            className={`px-3 py-1 rounded-full text-xs transition-colors border ${item.is_public ? 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100' : 'bg-gray-50 text-gray-500 dark:text-gray-400 dark:text-gray-400 border-gray-200 dark:border-slate-700 hover:bg-gray-100 dark:bg-gray-700'}`}
                          >
                 ...
                 {(historyFilterCategory ? history.filter(h => (h.category || "未分类") === historyFilterCategory) : history).length === 0 && (
                     <div className="col-span-full py-16 text-center text-gray-500 dark:text-gray-400 dark:text-gray-400 bg-gray-50 rounded-xl border border-dashed border-gray-300">
           ...
           <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-slate-700">
             ...
             <div className="flex flex-col md:flex-row gap-6">
                     ...
                     <ul className="space-y-1">
                         <li>
                             <button
                                 ...
                                 className={`w-full text-left px-3 py-2 rounded-lg text-sm font-semibold transition-colors ${communityFilterCategory === '' ? 'bg-purple-100 text-purple-700' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-700'}`}
                             >
                                 全部笔记
                             </button>
                         </li>
                         {['AI', '矩阵分析', '机器学习', '编程开发', '系统架构', '科技前沿', '未分类'].map(cat => (
                             <li key={cat}>
                                 <button
                                     ...
                                     className={`w-full text-left px-3 py-2 rounded-lg text-sm font-semibold transition-colors ${communityFilterCategory === cat ? 'bg-purple-100 text-purple-700' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-700'}`}
                                 >
                                     {cat}
                                 </button>
                             </li>
                 ...
                 <div key={item.id} onClick={() => loadCommunityDetail(item.id)} className="border border-gray-200 dark:border-slate-700 p-6 rounded-xl hover:shadow-xl hover:border-purple-300 transition-all cursor-pointer bg-white dark:bg-slate-800 group hover:-translate-y-1">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300 line-clamp-3 leading-relaxed font-normal bg-gray-50/50 p-3 rounded-lg border border-gray-100">{item.content.replace(/[#*]/g, '')}</div>
          ...
          <div className={`grid gap-6 ${(result || preview || currentFileUrl) && viewMode === 'upload' ? 'lg:grid-cols-12' : viewMode === 'detail' ? 'lg:grid-cols-12 max-w-5xl mx-auto' : 'lg:grid-cols-1 max-w-3xl mx-auto'}`}>
            ...
            <div className={`space-y-6 ${result || preview || currentFileUrl ? 'lg:col-span-4' : 'lg:col-span-1 border border-transparent'}`}>
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-md transition">
                    ...
                    <div className="mb-5">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button 
                                ...
                                className="bg-purple-50 dark:bg-purple-900/20 text-purple-600 px-3 py-2 rounded-lg text-sm font-bold border border-purple-200 hover:bg-purple-100 transition whitespace-nowrap"
                            >
                                添加
                            </button>
                        </div>
                    ...
                    <div className="relative border-2 border-dashed border-gray-200 dark:border-slate-700 rounded-xl p-6 hover:border-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30-50 dark:bg-indigo-900/20/30 focus-within:border-indigo-500 transition-all bg-gray-50 text-center cursor-pointer group mb-5">
                        <input
                            type="file"
                            multiple
                    ...
                    <div className="bg-white dark:bg-slate-800 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 relative group hidden lg:block">
                        ...
                        <div className="bg-gray-50/50 rounded-xl overflow-hidden flex items-center justify-center min-h-[250px] border border-gray-200 dark:border-slate-700">
                            {(preview || (currentFileUrl && currentFileUrl.match(/\.(jpeg|jpg|gif|png)$/i))) ? (
                                ...
                                <a href={currentFileUrl} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center p-8 text-indigo-600 dark:text-indigo-400 hover:bg-white rounded-xl transition border border-transparent hover:border-indigo-100 hover:shadow-sm">
                ...
                <div className={`flex flex-col gap-6 ${isFullscreen ? 'fixed inset-2 md:inset-6 z-[100] transition-all bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-0' : (viewMode === 'detail' ? 'lg:col-span-12' : 'lg:col-span-8')}`}>
                    ...
                    <div className="flex justify-between items-start bg-gray-50/80 px-8 py-5 border-b border-gray-200 dark:border-slate-700">
                        <div className="flex items-start space-x-3 flex-1 min-w-0 mr-4">
                            {viewMode === 'detail' && (
                                  <button onClick={() => { setViewMode(previousViewMode); if(previousViewMode==='history') fetchHistory(searchQuery); else if(previousViewMode==='community') fetchCommunityNotes(searchQuery); }} className="p-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 rounded-lg text-gray-700 dark:text-gray-200 mr-2 transition-colors cursor-pointer" title="返回列表">
                            ...
                            <div className="flex-1 w-full">
                                {isEditing ? (
                                    <input 
                                        ...
                                        className="text-lg font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 m-0 w-full bg-white border border-gray-300 rounded px-2 py-1 focus:outline-none focus:border-indigo-500" 
                                    />
                                ) : (
                                        ...
                                        {isEditing ? (
                                            <>
                                                ...
                                                <input 
                                                    ...
                                                    className="w-28 text-xs px-3 py-1 text-gray-600 dark:text-gray-300 bg-gray-50 border border-dashed border-gray-300 hover:border-purple-300 focus:border-purple-400 focus:bg-white focus:outline-none rounded-full transition-all placeholder:text-[10px] placeholder:leading-tight"
                                                />
                                            </>
                                        ) : (
                        ...
                        <div className="flex items-center space-x-2 shrink-0">
                            {currentNoteId && isNoteOwner && (
                                <button 
                                  ...
                                  className={`px-4 py-2 border rounded-lg font-bold transition-all text-sm flex items-center shadow-sm ${isPublic ? 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100' : 'bg-gray-50 text-gray-500 dark:text-gray-400 dark:text-gray-400 border-gray-200 dark:border-slate-700 hover:bg-gray-100 dark:bg-gray-700'}`}
                                >
                                  {isPublic ? '已公开 👍' : '设为公开'}
                                </button>
                            )}
                            ...
                            <button
                                ...
                                className={`px-4 py-2 border rounded-lg font-bold transition-all text-sm flex items-center shadow-sm ${isFullscreen ? 'bg-amber-50 text-amber-700 border-amber-200 hover:bg-amber-100' : 'bg-white text-gray-700 dark:text-gray-200 border-gray-300 hover:bg-gray-50'}`}
                            >
                                {isFullscreen ? (
                                    <>
                            ...
                            <button
                                ...
                                className="bg-white border border-gray-300 text-gray-700 dark:text-gray-200 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-100 dark:text-gray-100 px-4 py-2 rounded-lg font-bold transition-all text-sm flex items-center shadow-sm hover:shadow"
                            >
                        ...
                        {isEditing ? (
                            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6 w-full items-stretch ${isFullscreen ? 'h-full' : 'h-full min-h-[600px]'}`}>
                                ...
                                <div className={`flex flex-col rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden bg-white ${isFullscreen ? 'h-full' : 'h-[600px]'}`}>
                                    <div className="bg-gray-50 px-4 py-3 border-b border-gray-200 dark:border-slate-700 flex items-center font-bold text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">
